...
<form action="action_create_bank" method="post" id="createBankForm" enctype='multipart/form-data'>
        ...
        <input type="number" class="form-control mt-3" name="minLoan" id="minLoan" placeholder="Minimum down payment">
